  ...
  return (
    <>
      ...
      <div className="shadow rounded-lg flex w-full hover:bg-green-50 hover:shadow-md hover:scale-105 duration-300">
        <div>
          <div className="px-2 md:px-3 lg:px-4 py-5 h-full text-2xl bg-green-300 rounded-l-lg font-bold text-rose-50 flex justify-center items-center">
            {number}
          </div>
        </div>
      ...
      >
        <div>
          {/* Head */}
          <div className="p-3 rounded-t-lg bg-green-500 text-rose-50 relative">
            <div className="absolute top-0 right-0 p-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 cursor-pointer hover:fill-rose-50 hover:stroke-green-500"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="2"
